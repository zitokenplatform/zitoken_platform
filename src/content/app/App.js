    ...
    return (
      <div className={style.App}>
        ...
        <div className={style.content}>
          ...
          <p className={style.textContent}>Zitoken platform is a blockchain game platform, on which is possible to play different games
        ...
        <div className={style.AppFoot}>
          ...
          <div className={style.AppFootLink}>
            <Grid container spacing={16}>
              ...
              <Grid item><a href="mailto:support@zioken.me">Support</a></Grid>
            </Grid>
          </div>
        </div>
      </div>
